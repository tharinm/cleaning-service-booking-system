                ...
                if(password_verify($_POST['password'], $fetch['password']))
                {
                 ...
                 //   $_SESSION['login'] = true;
                   // $_SESSION['name'] = $fetch['name'];
                    ...
                    header("refresh: 0; url=http://localhost/DCSMS-v1/Customer-Dashboard/postjob.php");
                  ...
                  //  $_SESSION['login'] = true;
                   // $_SESSION['name'] = $fetch['name'];
                    echo "<script> alert('Login Successfully');</script>";
                    header("refresh: 0; url=http://localhost/DCSMS-v1/Employee-Dashboard/findjob.php");
                    }
                  ...
                  //  $_SESSION['login'] = true;
                   // $_SESSION['name'] = $fetch['name'];
                    echo "<script> alert('Login Successfully');</script>";
                    header("refresh: 0; url=http://localhost/DCSMS-v1/Admin-Dashboard/registeremployee.html");
                    }
