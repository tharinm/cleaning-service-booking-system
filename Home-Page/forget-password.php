...
function sendemail($email, $reset_token)
{
    ...
    try {
        ...
        $mail->Body    = "Clik the link to reset your password <a href='http://localhost/DCSMS-v1/Home-Page/reset-password.php?email=$email&token=$reset_token'>reset password</a>";
        $mail->send();
        return true;
    } catch (Exception $e) {
        return false;
