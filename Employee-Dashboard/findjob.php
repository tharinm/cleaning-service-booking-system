            ...
            <table class="table table py-4">
                ...
                <?php
                 ...
                 /* if(isset($_POST['accept']))
                  ...
                  //  $sql2=mysqli_query($conn,"SELECT emp_id from registered_employee ");
                    // $result2 = mysqli_fetch_array($sql2);

                    
                    
                    $sql3 = mysqli_query($conn, "UPDATE job_order SET status='Accepted' WHERE job_order_id=1");
                    if($sql3){
                      echo "<script> alert('Job Accepted');
                      </script>";
                      //header('http://localhost/dcsmsv-2/Employee-Dashboard/works.php');
                    }
