...
include_once('../Home-Page/config.php');
 ...
 if(isset($_POST['complete']))
 {
      ...
      $result = mysqli_query($conn,"UPDATE complete set c_complete=1 where order_id=1 ");

      if($result)
      {
        echo "<script>alert('Job completed sucussfully')</script>";
        header("refresh: 0; url=http://localhost/DCSMS-v1/Customer-Dashboard/complaign.php");
      }
      else{
  ...
  $sql="SELECT job_order_id,job_order_category,job_order_date  from job_order where job_order_id=1";
