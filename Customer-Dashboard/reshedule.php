...
if (isset($_POST['submit2'])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO reshedule(re_date,re_time)VALUES($date,$time)");
                ...
                <tbody class="text-center">
                    <div class="col-md-4 mb-4">
                        <tr>
                            ...
                            <td><input type="submit" class='btn btn-danger text-white btn btn-sm col-sm-6' name="cancel" value="Cancel"></td>
                        </tr>
